...
const ChairsideCard: React.FC<ChairsideCardProps> = ({
    ...
    videoSrc = "./videos/progettazione-digitale.mp4",
    ...
    return (
        <div
            className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 flex items-center  gap-0"
            data-aos="fade-left"
        >
            {/* Video Section - Aspect ratio 9:16 (verticale) */}
            <div className="relative w-64 h-96 flex-shrink-0 hidden lg:block">
                <video
                    src={videoSrc}
                    poster={videoPoster}
                    autoPlay
                ...
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            duration: "00:00:18", // Cambia con la durata reale
            ...
            {/* Content Section */}
            <div className=" p-6 flex flex-col gap-4 items-center lg:items-start h-full">
